...
class DriverVersionHandler {
    ...
    void writeVersionFile(Driver driver) throws InstallWebDriversException {
    ...
    public boolean isSameVersion(Driver driver) throws InstallWebDriversException {
        try {
            ...
            throw new InstallWebDriversException("Failed to compare installed driver version with the driver version to install" + Utils.debugInfo(driver), e);
        }
    }
}
